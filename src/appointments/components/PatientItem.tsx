            ...
            <table className="table min-w-full overflow-x-scroll scrollbar h-2/3 overflow-y-scroll">
                ...
                <tr className="min-w-full h-20">
                    ...
                    <td className="p-2 text-left w-8">
                        <MdCheckCircleOutline className={`text-secondary text-sm border border-gray-300 rounded-full p-2 w-8 h-8`} />
                    </td>
                    <td className="p-2 text-left w-8">
                        <IoIosCloseCircleOutline  className={`text-secondary text-sm border border-gray-300 rounded-full p-2 w-8 h-8`} />
                    </td>
                    <td className="p-2 text-left w-8">
